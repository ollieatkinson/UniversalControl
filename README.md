...
- [docs/implementation-requirements.md](docs/implementation-requirements.md): what must be proven or built for native interop or the bridge fallback.
...
- [scripts/compare-native-admission-awdl-baseline.py](scripts/compare-native-admission-awdl-baseline.py): compares a redacted Windows TCP-observer summary against the Apple-to-Apple AWDL payload length/gap, burst, phase-window burst, and framing-bucket baseline.
