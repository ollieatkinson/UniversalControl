...
and expected-remote-instance yes/no. Do not commit raw `dns-sd` output.
...
- macOS browse sees `AnyUniversalControl Probe`.
...
- macOS browse/resolve sees `AnyUniversalControl Native Shape Probe`.
