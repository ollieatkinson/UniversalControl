...
- First connected offset: 3.71s
- First TargetConnect offset: 47.0s
...
- #1: ip=ipv6 endpoints=`link-local-v6`<->`link-local-v6` ports=`dynamic`<->`dynamic` packets=5506 payload_bytes=329356 nonzero_payload_packets=2972 max_payload_bytes=174 flags=`ack-only`=2534, `push`=2972 first_offset=1.55s last_offset=72.8s span=71.2s
  ...
  - phase-window payload bursts: `phase=first_connected,phase_offset=3.71s,burst=#1,start=1.55s,end=2.64s,packets=201,bytes=21942,pattern=bidirectional,lengths=122x111+93x84+55x2+82x2`, `phase=first_connected,phase_offset=3.71s,burst=#2,start=3.14s,end=4.26s,packets=194,bytes=21128,pattern=bidirectional,lengths=122x105+93x84+55x2+82x1`, `phase=first_connected,phase_offset=3.71s,burst=#3,start=5.26s,end=5.26s,packets=1,bytes=82,pattern=a_to_b_only,lengths=82x1`, `phase=first_target_connect,phase_offset=47.0s,burst=#10,start=46.9s,end=48.8s,packets=231,bytes=26008,pattern=bidirectional,lengths=122x155+93x70+55x2+82x2`, `phase=first_disconnect,phase_offset=43.9s,burst=#9,start=44.9s,end=45.0s,packets=2,bytes=96,pattern=bidirectional,lengths=48x2`, `phase=first_reconnect,phase_offset=44.1s,burst=#9,start=44.9s,end=45.0s,packets=2,bytes=96,pattern=bidirectional,lengths=48x2`
...
- #2: ip=ipv6 endpoints=`link-local-v6`<->`link-local-v6` ports=`dynamic`<->`dynamic` packets=128 payload_bytes=63336 nonzero_payload_packets=70 max_payload_bytes=1428 flags=`ack-only`=58, `ecn-cwr`=1, `push`=53 first_offset=1.54s last_offset=71.4s span=69.9s
  ...
  - phase-window payload bursts: `phase=first_connected,phase_offset=3.71s,burst=#2,start=4.22s,end=4.23s,packets=2,bytes=1242,pattern=bidirectional,lengths=621x2`, `phase=first_target_connect,phase_offset=47.0s,burst=#9,start=45.7s,end=45.7s,packets=3,bytes=1928,pattern=bidirectional,lengths=621x1+635x1+672x1`, `phase=first_target_connect,phase_offset=47.0s,burst=#10,start=46.9s,end=46.9s,packets=2,bytes=1242,pattern=bidirectional,lengths=621x2`, `phase=first_disconnect,phase_offset=43.9s,burst=#7,start=41.9s,end=42.3s,packets=12,bytes=14566,pattern=bidirectional,lengths=1428x7+658x1+714x1+867x1`, `phase=first_disconnect,phase_offset=43.9s,burst=#8,start=44.6s,end=45.0s,packets=23,bytes=26970,pattern=bidirectional,lengths=1428x14+641x2+978x2+3x1`, `phase=first_disconnect,phase_offset=43.9s,burst=#9,start=45.7s,end=45.7s,packets=3,bytes=1928,pattern=bidirectional,lengths=621x1+635x1+672x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#7,start=41.9s,end=42.3s,packets=12,bytes=14566,pattern=bidirectional,lengths=1428x7+658x1+714x1+867x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#8,start=44.6s,end=45.0s,packets=23,bytes=26970,pattern=bidirectional,lengths=1428x14+641x2+978x2+3x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#9,start=45.7s,end=45.7s,packets=3,bytes=1928,pattern=bidirectional,lengths=621x1+635x1+672x1`
...
- #1: ip=ipv4 endpoints=`private-v4`<->`public-v4` ports=`dynamic`<->`https` packets=2369 payload_bytes=647964 nonzero_payload_packets=1434 max_payload_bytes=1440 flags=`ack-only`=935, `ecn-cwr`=1, `push`=1057 first_offset=0.000s last_offset=116.5s span=116.5s
  ...
  - phase-window payload bursts: `phase=first_connected,phase_offset=3.71s,burst=#1,start=0.000s,end=2.18s,packets=145,bytes=7147,pattern=a_to_b_only,lengths=51x23+49x21+48x20+50x19`, `phase=first_connected,phase_offset=3.71s,burst=#2,start=2.62s,end=2.62s,packets=13,bytes=13920,pattern=a_to_b_only,lengths=1440x9+84x2+189x1+603x1`, `phase=first_connected,phase_offset=3.71s,burst=#3,start=3.08s,end=3.10s,packets=10,bytes=13584,pattern=b_to_a_only,lengths=1388x9+1092x1`, `phase=first_connected,phase_offset=3.71s,burst=#4,start=3.45s,end=3.49s,packets=18,bytes=24095,pattern=a_to_b_only,lengths=1440x16+526x1+529x1`, `phase=first_target_connect,phase_offset=47.0s,burst=#15,start=46.1s,end=46.1s,packets=1,bytes=915,pattern=a_to_b_only,lengths=915x1`, `phase=first_target_connect,phase_offset=47.0s,burst=#16,start=47.6s,end=48.2s,packets=41,bytes=3266,pattern=a_to_b_only,lengths=50x11+52x9+51x5+49x4`, `phase=first_target_connect,phase_offset=47.0s,burst=#17,start=48.6s,end=49.4s,packets=38,bytes=2395,pattern=a_to_b_only,lengths=51x10+52x7+50x5+53x5`, `phase=first_disconnect,phase_offset=43.9s,burst=#13,start=43.4s,end=43.5s,packets=12,bytes=15765,pattern=b_to_a_only,lengths=1388x11+497x1`, `phase=first_disconnect,phase_offset=43.9s,burst=#14,start=44.2s,end=44.2s,packets=19,bytes=24631,pattern=a_to_b_only,lengths=1440x16+530x2+531x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#13,start=43.4s,end=43.5s,packets=12,bytes=15765,pattern=b_to_a_only,lengths=1388x11+497x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#14,start=44.2s,end=44.2s,packets=19,bytes=24631,pattern=a_to_b_only,lengths=1440x16+530x2+531x1`
...
- #3: ip=ipv4 endpoints=`private-v4`<->`public-v4` ports=`dynamic`<->`https` packets=493 payload_bytes=91808 nonzero_payload_packets=330 max_payload_bytes=499 flags=`ack-only`=163, `push`=330 first_offset=0.702s last_offset=117.0s span=116.3s
  ...
  - phase-window payload bursts: `phase=first_connected,phase_offset=3.71s,burst=#2,start=4.06s,end=4.23s,packets=8,bytes=2233,pattern=bidirectional,lengths=499x3+57x1+65x1+82x1`, `phase=first_target_connect,phase_offset=47.0s,burst=#19,start=47.5s,end=47.6s,packets=8,bytes=2232,pattern=bidirectional,lengths=499x3+57x1+65x1+81x1`, `phase=first_disconnect,phase_offset=43.9s,burst=#16,start=41.9s,end=42.0s,packets=11,bytes=2967,pattern=bidirectional,lengths=499x4+57x3+80x1+184x1`, `phase=first_disconnect,phase_offset=43.9s,burst=#17,start=42.5s,end=42.5s,packets=8,bytes=2199,pattern=bidirectional,lengths=57x3+499x3+185x1+346x1`, `phase=first_disconnect,phase_offset=43.9s,burst=#18,start=44.2s,end=44.2s,packets=8,bytes=2226,pattern=bidirectional,lengths=499x3+58x2+80x1+185x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#17,start=42.5s,end=42.5s,packets=8,bytes=2199,pattern=bidirectional,lengths=57x3+499x3+185x1+346x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#18,start=44.2s,end=44.2s,packets=8,bytes=2226,pattern=bidirectional,lengths=499x3+58x2+80x1+185x1`
...
- #5: ip=ipv4 endpoints=`private-v4`<->`public-v4` ports=`dynamic`<->`https` packets=44 payload_bytes=15764 nonzero_payload_packets=25 max_payload_bytes=1161 flags=`ack-only`=19, `push`=25 first_offset=42.2s last_offset=45.4s span=3.25s
  ...
  - phase-window payload bursts: `phase=first_target_connect,phase_offset=47.0s,burst=#2,start=45.3s,end=45.4s,packets=12,bytes=7302,pattern=bidirectional,lengths=77x2+79x1+422x1+424x1`, `phase=first_disconnect,phase_offset=43.9s,burst=#1,start=42.2s,end=42.4s,packets=13,bytes=8462,pattern=bidirectional,lengths=77x2+811x2+1161x2+79x1`, `phase=first_disconnect,phase_offset=43.9s,burst=#2,start=45.3s,end=45.4s,packets=12,bytes=7302,pattern=bidirectional,lengths=77x2+79x1+422x1+424x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#1,start=42.2s,end=42.4s,packets=13,bytes=8462,pattern=bidirectional,lengths=77x2+811x2+1161x2+79x1`, `phase=first_reconnect,phase_offset=44.1s,burst=#2,start=45.3s,end=45.4s,packets=12,bytes=7302,pattern=bidirectional,lengths=77x2+79x1+422x1+424x1`
